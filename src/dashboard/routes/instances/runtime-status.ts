...
export function registerRuntimeStatusRoutes(app: Hono, deps: RouteDeps): void {
  ...
  // ---------------------------------------------------------------------------
  app.get(
    "/api/instances/:slug/runtime/status",
    permission({ action: ACTIONS.RUNTIME_STATUS, resource: { kind: "runtime" }, attributes: attr }),
    (c) => {
  ...
  // ---------------------------------------------------------------------------
  app.get(
    "/api/instances/:slug/runtime/sessions",
    permission({
      action: ACTIONS.RUNTIME_SESSIONS_LIST,
  ...
  app.delete(
    "/api/instances/:slug/runtime/sessions",
    permission({
      action: ACTIONS.RUNTIME_SESSIONS_CLEAR,
      resource: { kind: "runtime" },
      attributes: attr,
    }),
    (c) => {
