...
export function registerEventsRoutes(app: Hono, deps: RouteDeps): void {
  ...
  // ---------------------------------------------------------------------------
  app.get(
    "/api/instances/:slug/events",
    permission({ action: ACTIONS.EVENT_LIST, resource: { kind: "event" }, attributes: attr }),
    (c) => {
  ...
  // ---------------------------------------------------------------------------
  app.get(
    "/api/instances/:slug/events/stream",
    permission({ action: ACTIONS.EVENT_STREAM, resource: { kind: "event" }, attributes: attr }),
    (c) => {
      const { slug } = getInstanceContext(c);
