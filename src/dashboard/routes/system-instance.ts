...
export function registerSystemInstanceRoutes(app: Hono, deps: RouteDeps): void {
  ...
  app.get(
    "/api/system/status",
    permission({ action: ACTIONS.SYSTEM_INSTANCE_STATUS, resource: { kind: "system-instance" } }),
    (c) => {
  ...
  app.post(
    "/api/system/ensure",
    permission({ action: ACTIONS.SYSTEM_INSTANCE_ENSURE, resource: { kind: "system-instance" } }),
    async (c) => {
  ...
  app.post(
    "/api/system/query",
    permission({ action: ACTIONS.SYSTEM_INSTANCE_QUERY, resource: { kind: "system-instance" } }),
    (c) => {
  ...
  app.get(
    "/api/system/ready",
    permission({ action: ACTIONS.SYSTEM_INSTANCE_READY, resource: { kind: "system-instance" } }),
    (c) => {
      const instance = registry.getSystemInstance();
