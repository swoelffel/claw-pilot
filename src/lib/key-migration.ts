// src/lib/key-migration.ts
//
// Migration helpers that move legacy API keys (user_providers table, instance
// .env files) into the encrypted named_api_keys table.
// Extracted from crypto.ts to break the circular dependency
// crypto → named-key-repository → crypto.
//
// TODO(cleanup): remove after v0.62 — both tables are deprecated.
