...
- **v0.80.6** (current) — Enterprise Edition preparation Phase 0: pluggable permission middleware (`permission()` Hono factory, `ACTIONS` catalogue, `NullPermissionChecker`)
