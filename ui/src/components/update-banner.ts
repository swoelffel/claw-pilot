...
export class UpdateBanner extends LitElement {
  ...
  private _handleUpdate() {
    this.dispatchEvent(new CustomEvent("cp-update-start", { bubbles: true, composed: true }));
  }
          ...
          <div class="banner-left">
            ...
            <div class="banner-text">
              <span class="banner-title">
                ...
                ${msg("Updating OpenClaw…")}
              </span>
              <span class="banner-sub">${msg("This may take up to 60 seconds")}</span>
            </div>
          </div>
        </div>
      `;
        ...
        <div class="banner success" role="status" aria-live="polite">
          <div class="banner-left">
            ...
            <div class="banner-text">
              ...
              <span class="banner-sub">${message ?? msg("All instances restarted")}</span>
            </div>
          </div>
        </div>
      `;
      ...
      return html`
        <div class="banner error" role="alert">
          <div class="banner-left">
            <span class="banner-icon">✕</span>
            <div class="banner-text">
              <span class="banner-title">${msg("Update failed")}</span>
