  ...
  private _renderSpinner() {
    return html`
      <div class="spinner-overlay">
        ...
        <div>
          ${msg("Deleting agent...", { id: "dad-spinner-deleting" })}
          <strong>${this.agent?.agent_id}</strong>
        </div>
      </div>
    `;
  }
  ...
  private _renderForm() {
    ...
    return html`
      <div class="dialog-body">
        ...
        <div class="agent-info">${a.name} — <strong>${a.agent_id}</strong></div>
        <div class="field">
