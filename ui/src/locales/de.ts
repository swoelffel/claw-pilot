...
export const templates = {
  ...
  "catd-seed-files-hint":
    "Erstellt SOUL.md, AGENTS.md, TOOLS.md, BOOTSTRAP.md, USER.md, HEARTBEAT.md",
  ...
  "profile-model-provider": "Anbieter",
  "profile-model-name": "Modell",
  "profile-add-alias": "Alias hinzufügen",
  "profile-remove-alias": "Entfernen",
  "profile-no-models": "Keine Modell-Aliase konfiguriert.",
  "profile-instructions-hint": "Markdown unterstützt. Maximal 10.000 Zeichen.",
  "profile-char-count": "Zeichen",
  "profile-import-from":
    "Anbieter, Modell-Aliase und API-Schlüssel aus einer bestehenden Instanz importieren.",
  "profile-select-instance": "Instanz auswählen...",
  "profile-import-btn": "Importieren",
  "profile-importing": "Wird importiert...",
  "profile-import-success": "Import erfolgreich",
};
